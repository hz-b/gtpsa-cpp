...
namespace gtpsa {
  ...
  public:
    ...
    { TpsaBridge<T> res(*this, mad::init::same); res._copyInPlace(*this); return res; }
    ...
    */
     ...
     * for pybind 11
     */
    inline void _set0(                             typename T::base_type a, typename T::base_type b)
    { this->set(a, b);}
    inline void _setm(const std::vector<ord_t>& m, typename T::base_type a, typename T::base_type b)
    { this->set(m, a, b);}

    /**
     * @brief a*x[0]+b
     */
    inline void set(                              typename T::base_type a, typename T::base_type b)
    { this->m_impl.set0(   a, b ); }

    /**
     * @brief a*x[i]+b
     */
    inline void set(const idx_t i               , typename T::base_type a, typename T::base_type b)
    { this->m_impl.seti(i, a, b ); }
    /**
     * @brief a*x[m]+b
     */
    inline void set(const std::string& s        , typename T::base_type a, typename T::base_type b)
    { this->m_impl.sets(s, a, b ); }
    /**
     * @brief a*x[m]+b
     */
    inline void set(const std::vector<ord_t>& m , typename T::base_type a, typename T::base_type b)
     ...
     */
    inline auto setsm(const std::vector<int> m, typename T::base_type a, typename T::base_type b)
    ...
    inline void rgetOrder(const TpsaBridge& src, const size_t order)
    { this->m_impl.rgetOrder(src.m_impl, order); };
    inline void rderiv(const TpsaBridge& src, const int iv)
    { this->m_impl.rderiv(src.m_impl, iv); };
     ...
     */
    inline void print(str_t name = nullptr, num_t eps = 1e-30, int nohdr = 0, FILE *stream = nullptr) const
    ...
    */
    ...
    (const TpsaBridge& a, const TpsaBridge& b, void(f)(const bridge_type& a, const bridge_type& b, bridge_type* r))
    {
    ...
    (const TpsaBridge& a, const base_type& b, void(f)(const bridge_type& a, const base_type& b, bridge_type* r))
    {
    ...
    inline void pow (const TpsaBridge<T>& a, const typename T::base_type v)
