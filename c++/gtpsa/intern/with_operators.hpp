...
namespace gtpsa {
  ...
  template<class T, typename = typename T::bridge_type, typename = typename T::base_type,
	   typename = typename T::ptr_type>
  ...
  public:
    ...
    inline void rgetOrder(const TpsaWithOp& o, int order)
     ...
     */
    inline TpsaWithOp<T>&  operator =  (const typename T::base_type& o )
    ...
    { radd(*this, o, this); return *this; }
    // (a_i-b_i)/max(|a_i|,1)
    inline TpsaWithOp& operator -= (const TpsaWithOp& o )
    { rsub(*this, o, this); return *this; }
    inline TpsaWithOp& operator *= (const TpsaWithOp& o )
    { rmul(*this, o, this); return *this; }
    inline TpsaWithOp& operator /= (const TpsaWithOp& o )
    { rdiv(*this, o, this); return *this; }
    ...
    inline TpsaWithOp  operator +  (const TpsaWithOp<T>& o ) const
    { return TpsaWithOp( add(*this, o) ); }
    inline TpsaWithOp  operator -  (const TpsaWithOp<T>& o ) const
    { return TpsaWithOp( sub(*this, o) ); }
    inline TpsaWithOp  operator *  (const TpsaWithOp<T>& o ) const
    { return TpsaWithOp( mul(*this, o) ); }
    inline TpsaWithOp  operator /  (const TpsaWithOp<T>& o ) const
    { return TpsaWithOp( div(*this, o) ); }
    ...
    {
      strm << "gtpsa cst:\n"
	   << std::scientific << std::setprecision(6) << std::setw(14) << this->cst();
      if(this->order()){
	...
	strm  << "\ngtpsa linear:\n";
	for(auto& e: v)
	  strm << std::scientific << std::setprecision(6) << std::setw(14) << e;
      }
      strm << "\n";
    }
  ...
  inline TpsaWithOp<T>  operator +  (const typename T::base_type a, const TpsaWithOp<T>& b)
  { return b + a; }
  template<class T, typename = typename T::base_type>
  inline TpsaWithOp<T>  operator -  (const typename T::base_type a, const TpsaWithOp<T>& b)
